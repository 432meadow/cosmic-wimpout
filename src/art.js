...
(function (global) {
  ...
  /* ---------------------------------------------------------------- font 3x5
     ...
     At three pixels wide, 0/O and 5/S want to be the same shape, and were: a
     rules screen full of "5s and 10s" read as "Ss and 1Os". Resolved by a rule
     rather than a one-off tweak -- DIGITS KEEP SQUARE CORNERS, LETTERS CUT
     THEIRS. That gives O and S a rounded feel against a blocky 0 and 5, and it
     generalises if another pair ever collides. */
  const GLYPHS = {
